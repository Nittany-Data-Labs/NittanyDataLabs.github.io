...
var app = angular.module('aizenor', ['ngRoute', 'ngAnimate']);
...
app.controller('ParticlesCtrl', function($scope) {
    ...
    window.requestAnimFrame = (function(){
      return  window.requestAnimationFrame       ||
    		  ...
    		  function( callback ){
    			window.setTimeout(callback, 100000 / 10);
    		  };
    })();
    ...
    function Particle() {
    	...
    	var colors = ["#FF6C72", "#FEB96C", "#A8DD85", "#83C6F8"];
    ...
    function distance(p1, p2) {
    	...
    	if(dist <= minDist) {
    		...
    		// Draw the line
    		ctx.beginPath();
    		ctx.strokeStyle = "rgba(250,250,250,"+ (1.2-dist/minDist) +")";
...
app.controller('TestimonialCtrl', function($scope) {
